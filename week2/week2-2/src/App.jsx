...
function App() {
  const [hoveredMovie, setHoveredMovie] = useState(null); // 호버된 영화 정보 상태
  return (
    <div className="wrapper">
      ...
      {movies.results.map((movie) => (
        <div
          key={movie.id}
          className="card"
          onMouseEnter={() => setHoveredMovie(movie)} // 마우스 호버 시 해당 영화 정보 설정
          onMouseLeave={() => setHoveredMovie(null)} // 마우스가 영화 카드를 벗어날 때 영화 정보 초기화
        >
          {/* 마우스 호버 시 영화 설명 표시 */}
          {hoveredMovie === movie && (
